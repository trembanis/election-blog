...
```{r fig z code, echo=FALSE, include=FALSE, warning=FALSE}
# sequester training data
...
figz <- ggarrange(az_errors, ga_errors, mi_errors, nv_errors, nc_errors, pa_errors, wi_errors)
```

```{r fig z print, echo=FALSE, include=TRUE, warning=FALSe}
figz
```
