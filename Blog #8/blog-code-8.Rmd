...
d_popvote <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/popvote_1948_2020(2).csv")
d_state_popvote <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/state_popvote_1948_2020(2).csv")

# Read elector distribution dataset. 
d_ec <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/corrected_ec_1948_2024(2).csv")

# Read polling data. 
d_polls <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/national_polls_1968-2024(5).csv")
d_state_polls <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/state_polls_1968-2024(5).csv")
...
# Read county data.
d_county <- read_csv("/Users/ellatrembanis/Downloads/county_turnout.csv")
...
# Read shocks data.
hurricanes <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/hurricanes_1996_2016.csv")
protests <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/protests.csv")
scotus_review <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/supreme_court_congressional_review.csv")
scotus_precedents <- read_csv("/Users/ellatrembanis/Desktop/Gov 1347/election-blog/election-blog/Week8/data/supreme_court_precedents.csv")
```
...
tfmc_az <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Arizona) # regression
...
tfmc_ca <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = California)
summary(tfmc_ca)
...
tfmc_fl <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Florida)
summary(tfmc_fl)
...
tfmc_ga <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Georgia)
summary(tfmc_ga)
...
tfmc_md <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Maryland)
summary(tfmc_md)
...
tfmc_mi <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Michigan)
summary(tfmc_mi)
...
tfmc_mn <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Minnesota)
summary(tfmc_mn)
...
tfmc_mo <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Missouri)
summary(tfmc_mo)
...
tfmc_mt <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Montana)
summary(tfmc_mt)
...
tfmc_nv <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Nevada)
summary(tfmc_nv)
...
tfmc_nh <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `New Hampshire`)
summary(tfmc_nh)
...
tfmc_nm <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `New Mexico`)
summary(tfmc_nm)
...
tfmc_ny <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `New York`)
summary(tfmc_ny)
...
tfmc_nc <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `North Carolina`)
summary(tfmc_nc)
...
tfmc_oh <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Ohio)
summary(tfmc_oh)
...
tfmc_pa <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Pennsylvania)
summary(tfmc_pa)
...
tfmc_tx <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Texas)
summary(tfmc_tx)
...
tfmc_va <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Virginia)
summary(tfmc_va)
...
tfmc_wi <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Wisconsin)
summary(tfmc_wi)
...
tfmc_al <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Alabama)
summary(tfmc_al)
...
tfmc_ak <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Alaska)
summary(tfmc_ak)
...
tfmc_ar <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Arkansas)
summary(tfmc_ar)
...
tfmc_co <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Colorado)
summary(tfmc_co)
...
tfmc_ct <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Connecticut)
summary(tfmc_ct)
...
tfmc_de <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Delaware)
summary(tfmc_de)
...
tfmc_hi <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Hawaii)
summary(tfmc_hi)
...
tfmc_id <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Idaho)
summary(tfmc_id)
...
tfmc_il <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Illinois)
summary(tfmc_il)
...
tfmc_in <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Indiana)
summary(tfmc_in)
...
tfmc_ia <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Iowa)
summary(tfmc_ia)
...
tfmc_ks <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Kansas)
summary(tfmc_ks)
...
tfmc_ky <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Kentucky)
summary(tfmc_ky)
...
tfmc_la <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Louisiana)
summary(tfmc_la)
...
tfmc_me <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Maine)
summary(tfmc_me)
...
tfmc_ma <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Massachusetts)
summary(tfmc_ma)
...
tfmc_ms <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Mississippi)
summary(tfmc_ms)
...
tfmc_ne <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Nebraska)
summary(tfmc_ne)
...
tfmc_nj <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `New Jersey`)
summary(tfmc_nj)
...
tfmc_nd <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `North Dakota`)
summary(tfmc_nd)
...
tfmc_ok <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Oklahoma)
summary(tfmc_ok)
...
tfmc_or <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Oregon)
summary(tfmc_or)
...
tfmc_ri <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `Rhode Island`)
summary(tfmc_ri)
...
tfmc_sc <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `South Carolina`)
summary(tfmc_sc)
...
tfmc_sd <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `South Dakota`)
summary(tfmc_sd)
...
tfmc_tn <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Tennessee)
summary(tfmc_tn)
...
tfmc_ut <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Utah)
summary(tfmc_ut)
...
tfmc_vt <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Vermont)
summary(tfmc_vt)
...
tfmc_wa <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Washington)
summary(tfmc_wa)
...
tfmc_wv <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = `West Virginia`)
summary(tfmc_wv)
...
tfmc_wy <- lm(state_pv2p ~ ics + mean_support + prev_admin + state_pv2p_lag + poll_week_3, data = Wyoming)
summary(tfmc_wy)
...
d_pop_tfmc <- d_state_tfmc |>
  ...
  select(year, party, candidate, pv2p, ics, prev_admin, prev_admin, incumbent_party, GDP_growth_quarterly, poll_week_3) |> # choose only national vars
  mutate(pv2p_lag = lag(pv2p, n = 1))
d_pop_tfmc[1, "pv2p_lag"] = 0.493511945857
pop24 <- d_pop_tfmc |> filter(year == 2024) # testing data
tfmc_pop <- lm(pv2p ~ ics + poll_week_3 + prev_admin + pv2p_lag, data = d_pop_tfmc)
summary(tfmc_pop) # adjusted r-squared 0.7618
pop_pred <- predict(tfmc_pop, pop24, interval = "none") # 52.78% Harris 2-party popular vote
```

```{r simulation, echo=FALSE, include=FALSE, warning=FALSE}
# Standardize number of columns - training data.
Alabama <- Alabama |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Alaska <- Alaska |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Arkansas <- Arkansas |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Arizona <- Arizona |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
California <- California |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Colorado <- Colorado |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Connecticut <- Connecticut |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Delaware <- Delaware |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Florida <- Florida |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Georgia <- Georgia |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Hawaii <- Hawaii |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Idaho <- Idaho |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Illinois <- Illinois |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Indiana <- Indiana |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Iowa <- Iowa |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Kansas <- Kansas |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Kentucky <- Kentucky |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Louisiana <- Louisiana |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Maine <- Maine |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Maryland <- Maryland |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Massachusetts <- Massachusetts |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Michigan <- Michigan |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Minnesota <- Minnesota |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Mississippi <- Mississippi |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Missouri <- Missouri |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Montana <- Montana |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Nebraska <- Nebraska |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Nevada <- Nevada |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`New Hampshire` <- `New Hampshire` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`New Jersey` <- `New Jersey` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`New Mexico` <- `New Mexico` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`New York` <- `New York` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`North Carolina` <- `North Carolina` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`North Dakota` <- `North Dakota` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Ohio <- Ohio |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Oklahoma <- Oklahoma |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Oregon <- Oregon |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Pennsylvania <- Pennsylvania |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`Rhode Island` <- `Rhode Island` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`South Carolina` <- `South Carolina` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`South Dakota` <- `South Dakota` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Tennessee <- Tennessee |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Texas <- Texas |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Utah <- Utah |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Vermont <- Vermont |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Virginia <- Virginia |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Washington <- Washington |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
`West Virginia` <- `West Virginia` |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Wisconsin <- Wisconsin |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Wyoming <- Wyoming |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
...
Alabama24 <- Alabama24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Alaska24 <- Alaska24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Arkansas24 <- Arkansas24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Arizona24 <- Arizona24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
California24 <- California24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Colorado24 <- Colorado24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Connecticut24 <- Connecticut24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Delaware24 <- Delaware24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Florida24 <- Florida24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Georgia24 <- Georgia24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Hawaii24 <- Hawaii24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Idaho24 <- Idaho24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Illinois24 <- Illinois24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Indiana24 <- Indiana24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Iowa24 <- Iowa24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Kansas24 <- Kansas24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Kentucky24 <- Kentucky24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Louisiana24 <- Louisiana24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Maine24 <- Maine24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Maryland24 <- Maryland24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Massachusetts24 <- Massachusetts24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Michigan24 <- Michigan24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Minnesota24 <- Minnesota24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Mississippi24 <- Mississippi24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Missouri24 <- Missouri24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Montana24 <- Montana24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Nebraska24 <- Nebraska24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Nevada24 <- Nevada24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
NH24 <- NH24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
NJ24 <- NJ24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
NM24 <- NM24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
NY24 <- NY24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
NC24 <- NC24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
ND24 <- ND24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Ohio24 <- Ohio24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Oklahoma24 <- Oklahoma24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Oregon24 <- Oregon24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Pennsylvania24 <- Pennsylvania24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
RI24 <- RI24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
SC24 <- SC24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
SD24 <- SD24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Tennessee24 <- Tennessee24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Texas24 <- Texas24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Utah24 <- Utah24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Vermont24 <- Vermont24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Virginia24 <- Virginia24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Washington24 <- Washington24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
WV24 <- WV24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Wisconsin24 <- Wisconsin24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
Wyoming24 <- Wyoming24 |> select(year, state, party, state_pv2p, ics, prev_admin, poll_week_3, state_pv2p_lag, mean_support)
...
# Run model. 
mod_lm_dem <- lm(state_pv2p ~ ics + prev_admin + poll_week_3 + state_pv2p_lag + mean_support, 
                 data = d_train)
summary(mod_lm_dem)

# Simple simulation. 
simp.vars <- c("ics", "prev_admin", "poll_week_3", "state_pv2p_lag", "mean_support")
mod_lm_dem_simp <- lm(state_pv2p ~ ics + prev_admin + poll_week_3 + state_pv2p_lag + mean_support,
                      data = d_train)
...
pop_out_samp_errors <- sapply(1:1000, function(i) {
  ...
  mod <- lm(pv2p ~ ics + prev_admin + poll_week_3 + pv2p_lag,
...
mean(abs(pop_out_samp_errors)) # 2.35
...
figa <- ggplot() +
  ...
  ylab("Count") +
  ggtitle("Fig. A - Out-of-Sample Error (Popular Vote)") +
  my_theme()
```
...
fig2 <- ec24_rescaled |>
  ...
  scale_fill_gradient2(high = "#7CB9E8", # high (positive) values represent a greater average Republican vote share
                       ...
                       limits = c(-20, 20)) +
  ggtitle("Fig. II - State-Level Two-Party Popular Vote, 2024") +
  my_map_theme() +
  theme(strip.text = element_text(size = 12), 
        aspect.ratio = 0.75)
fig2
