...
```{r fig 1 code, echo=FALSE, include=FALSE}
...
```{r print, echo=FALSE, include=TRUE}
fig1
```
...
```{r fig 2 code, echo=FALSE, include=FALSE}
fig2 <- d_pop_vote |>
...
knitr::include_graphics("/images/fig3.png", error = FALSE)
```
...
knitr::include_graphics("/images/fig4.png", error = FALSE)
```
