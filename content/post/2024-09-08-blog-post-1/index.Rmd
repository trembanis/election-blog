...
# create simplified theme for maps (no axes)
...
# label states, match to geographic center
...
```{r print fig 3, echo=FALSE, include=TRUE, warning=FALSE}
fig3
```
...
```{r print fig4, echo=FALSE, include=TRUE, warning=FALSE}
fig4
```
