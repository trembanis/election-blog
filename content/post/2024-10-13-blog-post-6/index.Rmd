...
fig2 <- campaign_spending |>
  ...
  xlab("") + ylab("Campaign Fundraising") +
  ggtitle("Fig II. Campaign Fundraising by State, 2024") +
  my_theme() +
...
fig3 <- campaign_spending |>
  ...
  xlab("Democratic Fundraising (in Millions of $)") +
  ylab("State") +
  ggtitle("Fig III. Democratic Campaign Fundraising by State") +
  my_theme()
```
...
fig4 <- campaign_spending |>
  ...
  xlab("Republican Fundraising (in Millions of $)") +
  ylab("State") +
  ggtitle("Fig IV. Republican Campaign Fundraising by State") +
  my_theme()
```
