...
# Read polling data. 
d_polls <- read_csv("data/national_polls_1968-2024(1).csv")
d_state_polls <- read_csv("data/state_polls_1968-2024(1).csv")
...
# split data probabilistically (80%) for training & testing
set.seed(02138)
...
for (i in 1:m) {
  ...
  vep_turnout <- sapply(d_turnout_avg$vep_turnout, function(mu) {
    rnorm(1, mean = mu, sd = 0.05) # Simulate turnout from Gaussian centered on state average with (example) 5% SD.
  })
