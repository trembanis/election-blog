...
# use q2 gdp for 2024 to predict next pop vote (outliers omitted)
predict(gdp_without, GDP_new, interval = "prediction")

# use q2 unemployment for 2024 to predict next pop vote (outlier omitted)
...
# use multi OLS to predict next pop vote
